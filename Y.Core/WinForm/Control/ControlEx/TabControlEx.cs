...
namespace Y.Core.WinForm.Control
{
  ...
  public class TabControlEx : TabControl
  {
    ...
    private Color _CaptionForceColor = System.Drawing.SystemColors.ControlText;
        ...
        UpDownButtonPaintEventArgs e)
    {
      ...
      {
        upButtonBaseColor = System.Drawing.SystemColors.Control;
        upButtonBorderColor = System.Drawing.SystemColors.ControlDark;
        upButtonArrowColor = System.Drawing.SystemColors.ControlDark;
        downButtonBaseColor = System.Drawing.SystemColors.Control;
        downButtonBorderColor = System.Drawing.SystemColors.ControlDark;
        downButtonArrowColor = System.Drawing.SystemColors.ControlDark;
      }
    ...
    private class UpDownButtonNativeWindow : NativeWindow, IDisposable
    {
      ...
      private bool LeftKeyPressed()
      {
        ...
        {
          return (Win32.GetKeyState((int)Enums.KeyStatesMasks.VK_RBUTTON) < 0);
        }
        else
        {
          return (Win32.GetKeyState((int)Enums.KeyStatesMasks.VK_LBUTTON) < 0);
        }
      }
      ...
      protected override void WndProc(ref Message m)
      {
        switch (m.Msg)
        {
          case (int)Enums.WindowMessages.WM_PAINT:
            if (!_bPainting)
            {
