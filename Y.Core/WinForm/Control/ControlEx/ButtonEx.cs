      ...
      public void DrawBackGround(Graphics g)
      {
          ...
          switch (this._ControlState)
          {
              case EnumControlState.Default:
                  ...
                  {
                      GDIHelper.FillRectangle(g, roundRect, _theme.DefaultControlColor);
                      GDIHelper.DrawPathBorder(g, roundRect);
                  }
                  break;
              case EnumControlState.HeightLight:
                  GDIHelper.FillRectangle(g, roundRect, _theme.HeightLightControlColor);
                  GDIHelper.DrawPathBorder(g, roundRect);
                  break;
              case EnumControlState.Focused:
                  GDIHelper.FillRectangle(g, roundRect, _theme.FocusedControlColor);
                  GDIHelper.DrawPathBorder(g, roundRect);
